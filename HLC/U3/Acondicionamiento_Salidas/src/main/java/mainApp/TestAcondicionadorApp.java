...
public class TestAcondicionadorApp {
	...
	public static void main(String[] args) {
		...
		if (!assertIgual(Acondicionador.acondicionaElementoHtml("Hola Caracola"), "Hola Caracola",
				"acondicionaElementoHtml")) {
			errores++;
		}

		if (!assertIgual(Acondicionador.acondicionaElementoHtml("H<ola> Ca&racola"), "H&lt;ola&gt; Ca&amp;racola",
				"acondicionaElementoHtml")) {
			errores++;
		}

		if (!assertIgual(Acondicionador.acondicionaAtributoHtml("Hola Caracola"), "Hola Caracola",
				"acondicionaAtributoHtml")) {
			errores++;
		}

		if (!assertIgual(Acondicionador.acondicionaAtributoHtml("H<ola> Ca&ra\"co'la"),
				"H&lt;ola> Ca&amp;ra&#34;co&#39;la", "acondicionaAtributoHtml")) {
			errores++;
		}

		if (!assertIgual(Acondicionador.acondicionaContenidoCss("Hola Caracola"), "Hola Caracola",
				"acondicionaContenidoCss")) {
			errores++;
		}
